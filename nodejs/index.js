...
const UUID = process.env.UUID || 'eda77957-b641-4ffc-abd9-6aba25f29049';  // 在不同的平台运行了v1哪吒请修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'pella.kils.pp.ua';           // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYTBjN2ExMTEwZjIwZTgxMzMwYTAxN2VjOGQ5MjNmYzQiLCJ0IjoiNGUxNmJkOWQtOTdmNi00OTJhLTgzOTItZThmMjQ0Zjg2Y2YwIiwicyI6Ik5UQTBPVEpqTldZdFlqRTFaaTAwTUdJd0xXRXlZbVF0WlRnNE5EazNNbUZsTXprdyJ9';               // argo固定隧道token或json,留空即使用临时隧道
