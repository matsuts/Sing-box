...
const UUID = process.env.UUID || '74503e0e-ddcd-4485-b0a8-1742715fed04';  // 在不同的平台运行了v1哪吒请修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'hidencloudsg.kils.pp.ua';           // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYTBjN2ExMTEwZjIwZTgxMzMwYTAxN2VjOGQ5MjNmYzQiLCJ0IjoiNjM4Y2IyN2ItYWRlMS00ZDVjLWJiYzMtYTllOTYzMDdkYWZjIiwicyI6Ik1EaGhOekV3WVRndFpqTmlaQzAwT1RjeExUazRNbUV0WVdObU5qSXlPRE14WW1VeCJ9';               // argo固定隧道token或json,留空即使用临时隧道
